...
class MainSection extends React.Component<MainSectionProps, MainSectionState> {
  ...
  renderToggleAll = (completedCount: any): any => {
  ...
  renderFooter = (completedCount: any): any => {
  ...
  render() {
    ...
    const completedCount = todos.reduce((count: number, todo): number => todo.completed ? count + 1 : count, 0);
