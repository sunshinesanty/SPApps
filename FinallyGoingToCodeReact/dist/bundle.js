...
/***/ function(module, exports, __webpack_require__) {
	...
	var Hello_1 = __webpack_require__(6);
	var TodoCtrl_1 = __webpack_require__(7);
	var todoStore_1 = __webpack_require__(9);
	ReactDOM.render(React.createElement("div", null, React.createElement(mobx_react_devtools_1.default, null), React.createElement(Hello_1.Hello, {compiler: "TypeScript", framework: "React"}), React.createElement(TodoCtrl_1.TodoList, {store: todoStore_1.observableStore, tasksHeader: "My Tasks"})), document.getElementById("example"));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CreateTodoCtrl_1 = __webpack_require__(8);
	var TodoList = (function (_super) {
	    __extends(TodoList, _super);
	    function TodoList() {
	        var _this = this;
	        _super.apply(this, arguments);
	        this.getEditableTodoID = function () {
	            var todos = _this.props.store.todos;
	            var editableTodo = todos.filter(function (todo) { return todo.isEdit == true; });
	            if (editableTodo && editableTodo.length > 0)
	                return editableTodo[0];
	            return null;
	        };
	        this.filetrTodo = function (e) {
	            _this.props.store.filter = e.target.value;
	        };
	    }
	    TodoList.prototype.render = function () {
	        var _this = this;
	        var _a = this.props.store, filteredTodos = _a.filteredTodos, filter = _a.filter, pendingRequests = _a.pendingRequests;
	        return (React.createElement("div", null, this.props.tasksHeader, React.createElement("ul", null, filteredTodos.map(function (todo, idx) { return React.createElement(TodoView, {todo: todo, key: idx, store: _this.props.store}); })), pendingRequests > 0 ? React.createElement("div", null, "Loading...") : null, React.createElement("div", null, "CurrentFilter: ", React.createElement("input", {type: "text", value: filter, onChange: this.filetrTodo})), React.createElement("br", null), React.createElement("br", null), React.createElement(CreateTodoCtrl_1.CreateNewTodo, {store: this.props.store, task: this.getEditableTodoID()})));
	    };
	    TodoList = __decorate([
	...
	var TodoView = (function (_super) {
	    ...
	    function TodoView() {
	        var _this = this;
	        _super.apply(this, arguments);
	        this.onToggleCompleted = function () {
	            var todo = _this.props.todo;
	            todo.completed = !todo.completed;
	        };
	        this.onRename = function () {
	            _this.props.store.renameTodo(_this.props.todo);
	        };
	    }
	    TodoView.prototype.render = function () {
	        var todo = this.props.todo;
	        return (React.createElement("li", {onDoubleClick: this.onRename}, React.createElement("input", {type: 'checkbox', checked: todo.completed, onChange: this.onToggleCompleted}), todo.Title, todo.startdate
	            ? React.createElement("small", null, todo.startdate.toISOString())
	            : null, todo.enddate
	            ? React.createElement("small", null, todo.enddate.toISOString())
	            : null));
	    };
	    TodoView = __decorate([
	        mobx_react_1.observer
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var mobx_react_1 = __webpack_require__(5);
	var CreateNewTodo = (function (_super) {
	    __extends(CreateNewTodo, _super);
	    function CreateNewTodo(props) {
	        var _this = this;
	        _super.call(this, props);
	        this.Title = "";
	        this.isCompleted = false;
	        this.taskTitleChange = function (e) {
	            _this.props.task.Title = e.target.value;
	            _this.Title = e.target.value;
	        };
	        this.taskIsCmpltChange = function (e) {
	            _this.props.task.completed = e.target.value;
	            _this.isCompleted = e.target.value;
	        };
	        this.onNewTodo = function () {
	            var task = _this.props.task;
	            var isCompleted = _this.isCompleted;
	            if (task && task.id > 0) {
	                _this.props.store.updateTodo({
	                    taskId: task.id,
	                    taskIsCompleted: isCompleted,
	                    updtTitle: _this.Title
	                });
	            }
	            else {
	                _this.props.store.addTodo({ newTitle: _this.Title, taskIsCompleted: isCompleted });
	            }
	        };
	    ...
	    CreateNewTodo.prototype.render = function () {
	        var task = this.props.task;
	        return (React.createElement("div", null, React.createElement("div", null, "Title: ", React.createElement("input", {type: "text", onChange: this.taskTitleChange, value: (task && task.id > 0) ? task.Title : this.Title})), React.createElement("div", null, "Is Completed?", React.createElement("input", {type: "radio", onChange: this.taskIsCmpltChange, value: (task && task.id > 0) ? task.completed : this.isCompleted})), React.createElement("div", null, React.createElement("button", {onClick: this.onNewTodo}, "New Todo"), React.createElement("small", null, " (double-click a todo to edit) "))));
	    };
	    ;
	    CreateNewTodo = __decorate([
	        mobx_react_1.observer
	    ], CreateNewTodo);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ObservableTodoStore = (function () {
	    function ObservableTodoStore() {
	        var _this = this;
	        this.todos = mobx_1.observable([
	            {
	                Title: "Test Todos",
	                startdate: new Date(),
	                enddate: new Date(),
	        ...
	        mobx_1.autorun(function () {
	            console.log(_this.todos[0].Title);
	            console.log(_this.filter);
	        });
	    }
	    Object.defineProperty(ObservableTodoStore.prototype, "filteredTodos", {
	        get: function () {
	            var _this = this;
	            var matchFilter = new RegExp(this.filter, "i");
	            return this.todos.filter(function (todos) { return !_this.filter || matchFilter.test(todos.Title); });
	        },
	        enumerable: true,
	        configurable: true
	    });
	    Object.defineProperty(ObservableTodoStore.prototype, "completedTodosCount", {
	        get: function () {
	    ...
	    Object.defineProperty(ObservableTodoStore.prototype, "report", {
	        get: function () {
	    ...
	    ObservableTodoStore.prototype.addTodo = function (NewTaskData) {
	    ...
	    ObservableTodoStore.prototype.updateTodo = function (UpdateTaskData) {
	        //get the todo to be editable and set the isEdit to true
	        var replacedTodo = [];
	        this.todos.forEach(function (todo) { return replacedTodo.push(todo); });
	        var selectedItem = replacedTodo.filter(function (todo) { return todo.id == UpdateTaskData.taskId; });
	        if (selectedItem) {
	            var indexToEdit = replacedTodo.indexOf(selectedItem[0]);
	            if (indexToEdit > -1) {
	    ...
	    ObservableTodoStore.prototype.renameTodo = function (task) {
	        ...
	        var indexToEdit = -1;
	        //get the todo to be editable and set the isEdit to true
	        var selectedItem = replacedTodo.filter(function (todo) { return todo.id == task.id; });
	        if (selectedItem) {
	    ...
	    __decorate([
	        mobx_1.observable
	    ], ObservableTodoStore.prototype, "filter", void 0);
	    __decorate([
	        mobx_1.observable
	    ], ObservableTodoStore.prototype, "pendingRequests", void 0);
	    __decorate([
	        mobx_1.computed
	    ], ObservableTodoStore.prototype, "filteredTodos", null);
	    __decorate([
	        mobx_1.computed
	    ], ObservableTodoStore.prototype, "completedTodosCount", null);
	    __decorate([
	        mobx_1.computed
	    ], ObservableTodoStore.prototype, "report", null);
	    return ObservableTodoStore;
	}());
	exports.ObservableTodoStore = ObservableTodoStore;
	var tStore;
	exports.observableStore = tStore = new ObservableTodoStore();
